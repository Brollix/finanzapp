...
export const core = StyleSheet.create({
  ...
  centeredContent: { flex: 1, justifyContent: 'center', alignItems: 'center', paddingHorizontal: theme.spacing.md },
  ...
  errorText: { color: theme.colors.error, fontSize: theme.font.size.sm, textAlign: 'center', marginBottom: theme.spacing.md },
  linkText: { color: theme.colors.secondary, fontSize: theme.font.size.md, textAlign: 'center' },
