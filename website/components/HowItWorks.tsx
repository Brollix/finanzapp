  ...
  const steps = [
    {
      number: '1',
      title: 'Escanea',
      description: 'Abre la app y captura una foto de tu ticket de compra con la cámara.',
    },
    {
      number: '2',
      title: 'Procesa',
      description: 'Nuestra IA extrae automáticamente productos, precios y descuentos usando OCR y procesamiento inteligente.',
    },
    {
      number: '3',
      title: 'Analiza',
      description: 'Visualiza tus gastos, estadísticas y análisis de descuentos en el dashboard interactivo.',
    },
  ]
